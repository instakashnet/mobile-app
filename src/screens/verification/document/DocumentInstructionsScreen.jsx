    ...
    <SafeArea>
      <Container>
        ...
        <Card classes={['flex-row', 'items-center']}>
          ...
          <Text className='flex-wrap flex-1 ml-3'>La foto debe estar nítida y ser completamente legible.</Text>
        </Card>
        <View className='mt-8' />
        <Card classes={['flex-row', 'items-center']}>
          <FontAwesome name='lightbulb-o' color={colors.primary700} size={30} />
          <Text className='flex-wrap flex-1 ml-3'>Verifica que hay buena iluminación en tu entorno.</Text>
        </Card>
        <View className='mt-8' />
        <Card classes={['flex-row', 'items-center']}>
          <FontAwesome name='lightbulb-o' color={colors.primary700} size={30} />
          <Text className='flex-wrap flex-1 ml-3'>Recuerda ajustar el documento dentro del marco mostrado.</Text>
        </Card>
