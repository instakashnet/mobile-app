  ...
  return (
    <SafeArea>
      ...
      <KeyboardScrollAware>
        ...
        <Spacer variant="top" />
        <InputWrapper>
          <Input name="rateBuy" label="Compra" onChange={formik.handleChange("rateBuy")} keyboardType="decimal-pad" value={formik.values.rateBuy} />
        </InputWrapper>
        <Spacer variant="top" size={5} />
        <NotificationWrapper>
          <View style={{ flex: 0.9 }}>
            <Text>
              Alerta cuando la <Text variant="bold">VENTA</Text> esté por encima de
            </Text>
          </View>
        ...
        <Spacer variant="top" />
        <InputWrapper>
          <Input name="rateSell" label="Venta" onChange={formik.handleChange("rateSell")} keyboardType="decimal-pad" value={formik.values.rateSell} />
        </InputWrapper>
